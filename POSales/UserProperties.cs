...
namespace POSales
{
    public partial class UserProperties : Form
    {
        ...
        private void btnApply_Click(object sender, EventArgs e)
        {
            try
            {
                if ((MessageBox.Show("¿Estás seguro de que deseas cambiar las propiedades de esta cuenta?", "Change Properties", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes))
                 {
                    cn.Open();
                    ...
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Las propiedades de la cuenta se han cambiado correctamente.", "Update Properties", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    account.LoadUser();
                    this.Dispose();
                }
            }
